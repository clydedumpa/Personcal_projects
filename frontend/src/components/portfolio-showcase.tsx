      ...
      try {
        ...
        if (!response.ok || !payload.reply) {
          throw new Error(
            payload.error ??
              payload.details ??
              "Unable to reach the digital twin.",
          );
        }
        ...
        <section className={styles.hero}>
          ...
          >
            ...
            <div className={styles.heroMeta}>
              ...
              <a className={styles.metaPill} href={`mailto:${profile.contact.email}`}>{profile.contact.email}</a>
              <a className={styles.metaPill} href={`tel:${profile.contact.phone}`}>{profile.contact.phone}</a>
            </div>
                ...
                <article className={styles.portfolioCard} key={entry.title}>
                  ...
                  {entry.links?.length ? (
                    ...
                    <p className={styles.portfolioNote}>
                      {entry.note ??
                        "Add a live link or repository later by updating the portfolio data."}
                    </p>
                  )}
                </article>
              ))}
